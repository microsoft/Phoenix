...
-- Description:	<Description: Builds completed during a date range>
-- =============================================
CREATE PROCEDURE [dbo].[sp_Get_CMPMetrics_FirstTimeRightCount]
	-- Add the parameters for the stored procedure here
    @BeginDate date,
	@EndDate date
AS
BEGIN
SELECT DISTINCT(Cycle) AS 'FCYCLE', Count(Cycle) AS 'FCOUNT' FROM 
