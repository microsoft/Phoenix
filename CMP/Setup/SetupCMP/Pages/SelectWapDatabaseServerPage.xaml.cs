//-----------------------------------------------------------------------
// <copyright file="SelectWapDatabaseServerPage.xaml.cs" company="Microsoft">
...
namespace CMP.Setup
{
    ...
    /// </summary>
    public partial class SelectWapDatabaseServerPage : BasePageForWpfControls
    {
        #region Members
        ...
        /// </summary>
        public SelectWapDatabaseServerPage()
        {
        ...
        public override void OnApplyTemplate()
        {
            if (PropertyBagDictionary.Instance.PropertyExists(PropertyBagConstants.VMMSupportedVersionInstalled))
            {
                ...
                {
                    this.textBoxServer.Text = SetupConstants.WapSqlMachineName;
                }
                else
                {
                ...
                this.comboBoxInstance.Text = SetupConstants.WapSqlInstanceName;
                this.resetInstanceName();

                this.comboBoxExistingDatabaseName.Text = SetupConstants.WapDBName;
            ...
            {
                this.serverName = SetupInputs.Instance.FindItem(SetupInputTags.WapSqlMachineNameTag);
                ...
                this.selectedDatabase = SetupInputs.Instance.FindItem(SetupInputTags.WapSqlDatabaseNameTag);
        ...
        {
            this.textBoxPort.Text = (this.port != InputDefaults.WapSqlServerPort) ? this.port.ToString() : String.Empty;
        }
        ...
        {
            SetupInputs.Instance.EditItem(SetupInputTags.WapRemoteDatabaseImpersonationTag, this.checkBoxNewUserId.IsChecked.GetValueOrDefault(false));
            this.SetCredentialBlock();
            this.SetNextButtonState();
        }
