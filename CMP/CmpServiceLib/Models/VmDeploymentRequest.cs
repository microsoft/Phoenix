...
namespace CmpServiceLib.Models
{
    ...
    {
        public VmDeploymentRequest()
        {
            this.VmMigrationRequests = new List<VmMigrationRequest>();
        }
        ...
        public virtual ICollection<VmMigrationRequest> VmMigrationRequests { get; set; }
    }
}
