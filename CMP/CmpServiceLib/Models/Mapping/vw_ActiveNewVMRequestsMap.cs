...
{
    public class vw_ActiveNewVMRequestsMap : EntityTypeConfiguration<vw_ActiveNewVMRequests>
    {
        public vw_ActiveNewVMRequestsMap()
        {
            // Primary Key
            this.HasKey(t => t.ID);
            ...
            this.ToTable("vw_ActiveNewVMRequests");
