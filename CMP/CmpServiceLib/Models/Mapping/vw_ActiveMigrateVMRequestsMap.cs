...
{
    public class vw_ActiveMigrateVMRequestsMap : EntityTypeConfiguration<vw_ActiveMigrateVMRequests>
    {
        public vw_ActiveMigrateVMRequestsMap()
        {
            // Primary Key
            this.HasKey(t => t.ID);
            ...
            this.ToTable("vw_ActiveMigrateVMRequests");
