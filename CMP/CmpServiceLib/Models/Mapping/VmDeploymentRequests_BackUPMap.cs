...
{
    public class VmDeploymentRequests_BackUPMap : EntityTypeConfiguration<VmDeploymentRequests_BackUP>
    {
        public VmDeploymentRequests_BackUPMap()
        {
            // Primary Key
            this.HasKey(t => t.ID);
            ...
            this.ToTable("VmDeploymentRequests_BackUP");
