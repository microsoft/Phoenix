...
(function ($, global, undefined) {
    ...
    function ShowCreateVmWizard(currentUserInfo) {
        ...
        cdm.stepWizard({
            ...
            onComplete: function () {
                ...
                promise = global.CmpWapExtensionTenantExtension.Controller.createVm(subscriptionId, vmAppName, vmAppId, envResourcegroupname, vmServerName, vmDomain, vmAdminName, vmAdminPassword, vmSourceImage, vmSize, vmRegion, vmRole, vmDiskSpec, vmConfig, vmTagData, servicecategory, nic1, Msitmonitored, sqlConfig, iisconfig, environmentclass, accountAdminLiveEmailId, osCode, azureApiName);
    ...
    */
    ...
    CmpWapExtensionTenantExtensionActivationInit = function () {
        ...
        //});
        allSubscriptionIds = subscriptionRegisteredToService.map(function (x) {
            return x.id;
        });
    ...
    //*************************************************************************
    function fetchIISRoleServicesList(allSubscriptionIds) {
        $.ajax({
            type: 'POST',
    ...
    //*************************************************************************
    function fetchSQlAnalysisServiceModesList(allSubscriptionIds) {
        $.ajax({
            type: 'POST',
    ...
    //*************************************************************************
    function fetchSQlVersionsList(allSubscriptionIds) {
        $.ajax({
            type: 'POST',
    ...
    //*************************************************************************
    function fetchDomainNames(allSubscriptionIds) {
        $.ajax({
            type: 'POST',
    ...
    //*************************************************************************
    function fetchSizeInfoList(allSubscriptionIds) {
        $.ajax({
            type: 'POST',
    ...
    //*************************************************************************
    function fetchOsInfoList(allSubscriptionIds) {
        $.ajax({
            type: 'POST',
    ...
    //*************************************************************************
    function fetchRegionInfoList(allSubscriptionIds) {
        $.ajax({
            type: 'POST',
    ...
    //*************************************************************************
    function fetchAppInfoList(allSubscriptionIds) {
        return $.ajax({
            type: 'POST',
            url: getAppListUrl,
            contentType: 'application/json',
    ...
    //*************************************************************************
    function fetchResourceGroupList(allSubscriptionIds) {
        $.ajax({
            type: 'POST',
    ...
    //*************************************************************************
    function fetchEnvironmentTypesList(allSubscriptionIds) {
        $.ajax({
            type: 'POST',
    ...
    //*************************************************************************
    function fetchServerRolesList(allSubscriptionIds) {
        $.ajax({
            type: 'POST',
    ...
    //*************************************************************************
    function fetchServiceCategoriesList(allSubscriptionIds) {
        $.ajax({
            type: 'POST',
    ...
    //*************************************************************************
    function fetchNetworkNICList(allSubscriptionIds) {
        $.ajax({
            type: 'POST',
    ...
    //*************************************************************************
    function fetchServerRoleDriveMappingList(allSubscriptionIds) {
        $.ajax({
            type: 'POST',
    ...
    //*************************************************************************
    function fetchSQLCollationsList(allSubscriptionIds) {
        $.ajax({
            type: 'POST',
    ...
    //*************************************************************************
    function fetchSubscriptionMappings(allSubscriptionIds) {
        $.ajax({
            type: 'POST',
