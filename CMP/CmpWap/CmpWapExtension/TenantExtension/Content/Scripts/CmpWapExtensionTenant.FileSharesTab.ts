...
var domainList, sizeInfoList, osInfoList, subscriptionIdList, targetRegionsList, appList, environmenttypeList,
    serviceCategoryList, serverRoleList, networkNicList, serverroleDrivemappingList, sqlcollationList, sqlVersionList,
    selectedVmRow, navigation,vmDashboardInfo,iisroleservicesList,sqlanalysisservicemodesList,resourcegroupList;
//var restartProgressOperation;
...
(function ($, global, undefined?) {
    ...
    var grid,
        ...
        statusIcons = {
            ...
            Default: {
                ...
                iconName: "null" // cannot find icon for this type. Temporarily making the default type name as null to avoid non-display of icon
            }
        };
    ...
    function loadTab(extension, renderArea, initData) {
       ...
       var columns = [
             ...
             //   { name: "Source Image", field: "VmSourceImage", filterable: false, sortable: false },
              //  { name: "Address", field: "AddressFromVm", filterable: false, sortable: false }
                /*{ name: "subscriptionId", field: "SubscriptionId", filterable: false, sortable: false },
                { name: "Id", field: "Id", filterable: false, sortable: false },
                { name: "VmDomain", field: "VmDomain", filterable: false, sortable: false },
                { name: "VmAdminGroup", field: "VmAdminGroup", filterable: false, sortable: false },
                { name: "VmRole", field: "VmRole", filterable: false, sortable: false },
                { name: "VmDiskSpec", field: "VmDiskSpec", filterable: false, sortable: false },
                { name: "VmConfig", field: "VmConfig", filterable: false, sortable: false },
                { name: "VmTagData", field: "VmTagData", filterable: false, sortable: false }*/
            ];
