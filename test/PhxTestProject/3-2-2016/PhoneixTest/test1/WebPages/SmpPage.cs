...
namespace Phoenix.Test.UI.Framework.WebPages
{
    ...
    public class SmpPage : Page
    {
        ...
        public bool VerifyVmCreated(CreateVmData data)
        {
            ...
            //this.mainMenuTenantPortal.GetItems();
            ...
            //Log.Information("Server status: " + row.BuildStatus);
            //if (row.BuildStatus.Trim().ToLower().Contains("complete"))
            //{
            ...
            //else
            //{
            //    Log.Information("Create VM failed. VM name: " + data.serverName + ". Error messge: " + row.StatusMessage);
            //    return false;
            //}
        }
