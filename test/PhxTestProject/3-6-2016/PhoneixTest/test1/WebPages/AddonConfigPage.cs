...
namespace Phoenix.Test.UI.Framework.WebPages
{
    ...
    public class AddonConfigPage : SmpPage
    {
        ...
        public void SelectAddonServiceInTableAndCheckDatails(CreateAddonData data)
        {
            ...
            this.tableAddonServices = new HtmlTable(this, By.ClassName("fx-grid-full"));
            this.tableAddonServices.Rows[name].SelectAndCheckDatails(); // THE GIVEN KEY WAS NOT PRESENT IN THE DICTIONARY ??
