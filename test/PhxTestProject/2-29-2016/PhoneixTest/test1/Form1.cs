...
namespace Phoenix.Test.UI
{
    public partial class Form1 : Form
    {
        ...
        {
            this.textBox_TenantUserAccount.Text = "test01@microsoft.com";
            this.textBox_TenantPassword.Text = "Password0)";
            this.textBox_TenantPortalServer.Text = "khphoenixsql2.redmond.corp.microsoft.com";

            var test = new TenantPortalTest(this.textBox_TenantUserAccount.Text, this.textBox_TenantPassword.Text, this.textBox_TenantPortalServer.Text);
            test.TestInitialize();
            var createVmData = test.GetCreateVmData();
            var smpPage = test.LoginTenantProtal(this.textBox_TenantUserAccount.Text, this.textBox_TenantPassword.Text);
            //Assert.IsTrue(smpPage.VerifyVmCreated(createVmData), "Failed to create VM from new button.");
            if (smpPage.VerifyVmCreated(createVmData))
        ...
        {
            this.textBox_UserName.Text = "v-willc@microsoft.com";
            this.textBox_Password.Text = "XiaoGe1225";
            this.textBox_AdminPortalServer.Text = "khphoenixsql2.redmond.corp.microsoft.com";
            ...
            var test = new AdminPortalTest(this.textBox_UserName.Text, this.textBox_Password.Text, 
                this.textBox_AdminPortalServer.Text, 
                this.textBox_ClientId.Text, this.textBox_ClientKey.Text, 
                this.textBox_TenantId.Text, this.textBox1.Text);
            ...
            test.AdminCreateAddonTest(data);

            test.AdminOnboardSubscriptionTest(data);
