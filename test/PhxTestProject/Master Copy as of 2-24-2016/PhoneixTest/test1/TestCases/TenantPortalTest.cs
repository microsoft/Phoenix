...
namespace Phoenix.Test.UI.TestCases
{
    ...
    public class TenantPortalTest : WAPTestBase
    {
        ...
        public override void TestInitialize()
        {
            ...
            config = new DataSet();
            config.ReadXml(Directory.GetCurrentDirectory() + @"\..\..\App.config");
        ...
        public CreateVmData GetCreateVmData()
        {
            ...
            //Do I need to replace this line using the non-hardcoded parameters that this class is getting from the application form?
        ...
        public void ReadConfigTestUser()
        {
